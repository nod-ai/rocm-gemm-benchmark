...
module {
    func.func @main_0(%295 : !torch.vtensor<[4,32,2048,128],f16>, %298 : !torch.vtensor<[4,32,2048,128],f16>, %301 : !torch.vtensor<[4,32,2048,128],f16>) -> !torch.vtensor<[4,32,2048,128],f16> {
