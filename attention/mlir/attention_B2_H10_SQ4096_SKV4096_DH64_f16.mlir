...
module {
    func.func @main_0(%295 : !torch.vtensor<[2,10,4096,64],f16>, %298 : !torch.vtensor<[2,10,4096,64],f16>, %301 : !torch.vtensor<[2,10,4096,64],f16>) -> !torch.vtensor<[2,10,4096,64],f16> {
