...
module {
    func.func @main_0(%295 : !torch.vtensor<[2,64,1024,128],f16>, %298 : !torch.vtensor<[2,64,4096,128],f16>, %301 : !torch.vtensor<[2,64,4096,128],f16>) -> !torch.vtensor<[2,64,1024,128],f16> {
