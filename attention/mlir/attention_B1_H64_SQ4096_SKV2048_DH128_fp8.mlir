...
module {
    func.func @main_0(%295 : !torch.vtensor<[1,64,4096,128],f16>, %298 : !torch.vtensor<[1,64,2048,128],f16>, %301 : !torch.vtensor<[1,64,2048,128],f16>) -> !torch.vtensor<[1,64,4096,128],f16> {
